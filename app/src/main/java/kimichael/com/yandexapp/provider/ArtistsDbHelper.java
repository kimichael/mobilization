...
public class ArtistsDbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        final String SQL_CREATE_ARTISTS_TABLE = "CREATE TABLE " + ArtistEntry.TABLE_NAME + " (" +
                ArtistEntry.COLUMN_ID + " INTEGER PRIMARY KEY, " +
        ...
        final String SQL_CREATE_GENRES_TABLE = "CREATE TABLE " + GenreEntry.TABLE_NAME + " (" +
                GenreEntry.COLUMN_ID + " INTEGER PRIMARY KEY, " +
        ...
        final String SQL_CREATE_ARTISTS_GENRES_TABLE = "CREATE TABLE " + ArtistsGenresEntry.TABLE_NAME + " (" +
                ...
                "FOREIGN KEY(" + ArtistsGenresEntry.COLUMN_ARTIST_ID + ") REFERENCES " + ArtistEntry.COLUMN_ID + ") " +
                ArtistsGenresEntry.COLUMN_GENRE_ID + "INTEGER, " +
                "FOREIGN_KEY(" + ArtistsGenresEntry.COLUMN_GENRE_ID + ") REFERENCES " + GenreEntry.COLUMN_ID + ") " +
                "UNIQUE " + "(" + ArtistsGenresEntry.COLUMN_ARTIST_ID + ", "
                    + ArtistsGenresEntry.COLUMN_GENRE_ID + ")" + " ON CONFLICT IGNORE" + ")";
